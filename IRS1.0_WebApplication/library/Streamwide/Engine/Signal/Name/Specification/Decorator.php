 ...
 * and if it has a certain name
 */
class Streamwide_Engine_Signal_Name_Specification_Decorator extends Streamwide_Engine_Signal_Candidate_Specification_Decorator
{
    ...
    public function isSatisfiedBy( $candidate )
    {
        ...
        return $this->_spec->isSatisfiedBy( $candidate->getName() );
    }
