 ...
 * and if it has a "name" parameter with a certain value
 */
class Streamwide_Engine_Signal_Param_Name_Specification_Decorator extends Streamwide_Engine_Signal_Param_Specification_Decorator {
