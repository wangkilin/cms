 ...
 * and if it has a "policy" parameter with a certain value
 */
class Streamwide_Engine_Signal_Param_Policy_Specification_Decorator extends Streamwide_Engine_Signal_Param_Specification_Decorator {

    public function __construct( Streamwide_Specification_Abstract $spec )
    {
        parent::__construct( $spec, 'policy' );
    }
