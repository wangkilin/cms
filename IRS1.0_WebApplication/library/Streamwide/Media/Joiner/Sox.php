...
/**
 * Joins media files using SoX.
 *
 * @package    Streamwide_Media
 * @subpackage Streamwide_Media_Joiner
 */
class Streamwide_Media_Joiner_Sox implements Streamwide_Media_Joiner_Interface
{
    /**
     ...
     * @var string
     */
    protected $_defaultCommand = 'Streamwide_Media_Command_Sox';
    
    /**
     * Command instance.
     *
     * @var Streamwide_Media_Command_Sox
     */
    protected $_command;
    ...
    {
        // activate the join bahavior
        $this->_command->setJoin(true);
