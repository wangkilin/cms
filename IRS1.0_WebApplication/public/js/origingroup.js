                    ...
                    $.get($uri, function(response) {
                        ...
                        if ($(response).hasClass('error')) {
                            ...
                            $dialog.submit(function() {
                                ...
                                var $pagination = $('#origingroup-list tfoot'),
                                ...
                                $.post($uri, $params, function(response) {
                                    if (! $(response).hasClass('error')) {
                                        $('#origingroup-list table').replaceWith($(response).filter('#origingroup-list').find('table'));
                                        $('.pagination')
                                            .replaceWith($(response).find('.pagination'));
