...
/*
	...
	$Id: admin_announcements.php 11527 2009-03-09 06:24:07Z zhaolei $
*/
...
if(is_array($thevalue) && $thevalue) {
	...
	echo label(array('type'=>'text', 'alang'=>$alang['announcements_endtime_message'], 'text'=>'<input name="endtime" readonly type="text" id="endtime" value="'.sgmdate($thevalue['endtime']).'"><img src="'.S_URL.'/admin/images/time.gif" onClick="getDatePicker(\'endtime\', event, 21)"/>'));
	echo label(array('type'=>'table-end'));
