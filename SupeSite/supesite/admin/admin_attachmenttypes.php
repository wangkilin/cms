...
/*
	...
	$Id: admin_attachmenttypes.php 11150 2009-02-20 01:35:59Z zhaofei $
*/
...
if(is_array($listarr) && $listarr) {
	...
	foreach ($listarr as $listvalue) {
		...
		echo '<td align="center"><img src="'.S_URL.'/images/base/icon_edit.gif" align="absmiddle"> <a href="'.$newurl.'&op=edit&id='.$listvalue['id'].'">'.$alang['space_edit'].'</a> <img src="'.S_URL.'/images/base/icon_delete.gif" align="absmiddle"><a href="'.$newurl.'&op=delete&id='.$listvalue['id'].'">'.$alang['space_delete'].'</a></td>';
		echo '</tr>';
	}
