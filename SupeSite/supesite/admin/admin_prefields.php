...
/*
	...
	$Id: admin_prefields.php 11176 2009-02-23 08:44:44Z zhaolei $
*/
...
if(is_array($listarr) && $listarr) {
	...
	foreach ($listarr as $listvalue) {
		...
		echo '<td><a href="'.$newurl.'&op=edit&id='.$listvalue['id'].'">'.$alang['prefield_edit'].'</a> | <a href="'.$newurl.'&op=delete&id='.$listvalue['id'].'">'.$alang['prefield_delete'].'</a></td>';
		echo '</tr>';
	}
	echo label(array('type'=>'table-end'));
