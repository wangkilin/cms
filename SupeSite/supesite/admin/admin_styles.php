...
/*
	...
	$Id: admin_styles.php 11176 2009-02-23 08:44:44Z zhaolei $
*/
...
if(is_array($listarr) && $listarr) {
	...
	foreach ($listarr as $listvalue) {
		...
		echo '<td><a href="'.$theurl.'&op=edit&tplid='.$listvalue['tplid'].'">'.$alang['common_edit'].'</a> | <a href="'.$theurl.'&op=delete&tplid='.$listvalue['tplid'].'">'.$alang['common_delete'].'</a></td>';
		echo '</tr>';
	}
