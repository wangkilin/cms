...
/*
	...
	$Id: batch.common.php 11762 2009-03-24 05:34:09Z zhaolei $
*/
...
if ($action == 'emailfriend') {
	...
	if($itemid) {
		$query = $_SGLOBAL['db']->query("SELECT * FROM ".tname('spaceitems')." WHERE itemid='$itemid' AND folder='1' AND type='news'");
