...
<div id="wrap">
<div id="header">
<h2><a href="index.php" title="<?=$_SCONFIG['sitename']?>"><img src="admin/images/loginlogo.gif" alt="<?=$_SCONFIG['sitename']?>" /></a></h2>
...
<?php } ?>
<a href="javascript:history.back();">返回上一页</a> &nbsp; <a href="index.php">首页</a>
</div>

<div id="footer">
<p>
Powered by <a  href="http://x.discuz.net" target="_blank" title="">SupeSite</a> 7.0 
, 
