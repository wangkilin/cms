...
<?php include template('header'); ?><?php $ads = getad('system', 'news', '1'); ; ?>
...
</div><?php block("category", "type/news/isroot/1/order/c.displayorder/limit/0,100/cachetime/80800/cachename/category"); ?><ul class="ext_nav clearfix"><?php $dot = '|'; ?><?php $total = count($_SBLOCK['category']); ?><?php $i = 1;; ?>
...
</div><!--nav end--><?php block("spacenews", "haveattach/2/showattach/1/showdetail/1/order/i.dateline DESC/limit/0,11/subjectlen/48/subjectdot/0/messagelen/170/messagedot/1/cachetime/11930/cachename/picnews"); ?>
<?php if(!empty($_SBLOCK['picnews'])) { ?>
<?php $picnews = @array_slice($_SBLOCK['picnews'], 0, 5);; ?>
<?php } ?>
<div class="column">
<div class="col1">
<div class="clearfix">
...
<!--最新资讯--><?php block("spacenews", "order/i.dateline DESC/limit/0,3/cachetime/85400/subjectlen/40/subjectdot/0/showdetail/1/messagelen/150/messagedot/1/cachename/newnews1"); ?><div class="col4" id="hot_news">
<h3>最新资讯</h3>
...
<?php $ctime=1800+30*$ckey;; ?><?php $cachetime = 1877+30*$ckey;; ?><?php block("spacenews", "catid/$cat[subcatid]/order/i.dateline DESC/limit/0,6/cachetime/$cachetime/subjectlen/36/subjectdot/0/cachename/newslist"); ?> 
<?php if(($i % 2) == 0) { ?>
...
<!--最新评论资讯显示--><?php block("spacenews", "order/i.lastpost DESC/limit/0,10/subjectlen/26/subjectdot/0/cachetime/7500/cachename/newnews"); ?><div class="global_module margin_bot10 bg_fff">
...
<!--月度评论热点--><?php block("spacenews", "lastpost/2592000/order/i.replynum DESC/limit/0,10/cachetime/75400/subjectlen/26/subjectdot/0/cachename/replyhot"); ?><div class="global_module margin_bot10 bg_fff">
