...
//--------------- SupeSite设置 ---------------
$_SC['dbhost'] = 'localhost:3308';					//SupeSite数据库服务器(一般为本地localhost)
$_SC['dbuser'] = 'root';					//SupeSite数据库用户名
$_SC['dbpw'] = '4728999';						//SupeSite数据库密码
$_SC['dbname'] = 'supesite';						//SupeSite数据库名
$_SC['tablepre'] = 'supe_';					//SupeSite表名前缀(不能与论坛的表名前缀相同)
$_SC['pconnect'] = 0;						//SupeSite数据库持久连接 0=关闭, 1=打开
$_SC['dbcharset'] = 'gbk';					//SupeSite数据库字符集

$_SC['siteurl'] = '/supesite/supesite';						//SupeSite程序文件所在目录的URL访问地址。可以填写以 http:// 开头的完整URL，也可以填写相对URL。末尾不要加 /。如果程序无法自动获取，请务必手工修改为 http://www.yourwebsite.com/supesite 形式
...
// 数据库相关 (mysql 连接时)
define('UC_DBHOST', 'localhost:3308');				// UCenter 数据库主机
define('UC_DBUSER', 'root');					// UCenter 数据库用户名
define('UC_DBPW', '4728999');						// UCenter 数据库密码
...
// 通信相关
define('UC_KEY', '26r3G1M6sbz3C1f8z5obMfrfGbQfm7Vdw9m5P4U6e7J0b1x72eddg4kahdK9LdB2');						// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost/supesite/upload');						// UCenter 的 URL 地址, 在调用头像时依赖此常量
