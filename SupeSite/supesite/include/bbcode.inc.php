...
/*
	...
	$Id: bbcode.inc.php 11984 2009-04-24 04:12:49Z zhanglijun $
*/
...
function attachtag($aid) {
	...
	if(isset($attachlist[$aid])) {
		...
		if($attach['isimage']) {
			$replacement = "<p><a href=\"".B_URL."/attachment.php?aid=$attach[aid]\" target=\"_blank\"><img src=\"$attach[attachment]\" border=\"0\"><br>$attach[filename]</a></p>";
		} else {
