...
<!--{block name="spacenews" parameter="haveattach/2/showattach/1/showdetail/1/order/i.dateline DESC/limit/0,11/subjectlen/48/subjectdot/0/messagelen/170/messagedot/1/cachetime/11930/cachename/picnews"}-->
...
<div class="column">
	<div class="col1">
		...
		<!--最新资讯-->
		<!--{block name="spacenews" parameter="order/i.dateline DESC/limit/0,3/cachetime/85400/subjectlen/40/subjectdot/0/showdetail/1/messagelen/150/messagedot/1/cachename/newnews1"}-->
	...
	<div class="col2">
		...
		<!--最新评论资讯显示-->
		<!--{block name="spacenews" parameter="order/i.lastpost DESC/limit/0,10/subjectlen/26/subjectdot/0/cachetime/7500/cachename/newnews"}-->
		<div class="global_module margin_bot10 bg_fff">
		...
		<!--月度评论热点-->
		<!--{block name="spacenews" parameter="lastpost/2592000/order/i.replynum DESC/limit/0,10/cachetime/75400/subjectlen/26/subjectdot/0/cachename/replyhot"}-->
		<div class="global_module margin_bot10 bg_fff">
