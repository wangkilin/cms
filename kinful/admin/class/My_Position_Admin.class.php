...
require_once(MY_ROOT_PATH . '/class/My_Position.class.php');

class My_Position_Admin extends My_Position
{
    /****************** START::property zone *************************/
    ...
    public function & getPositions($mustLoadFromDb=false)
    {
        ...
        if(!isset($_system['position'])) {
            $selectPosition = "select * from #._position";
            $this->_db->query($selectPosition);
