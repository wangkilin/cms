...
class My_News extends My_Abstract
{
    ...
    /*
     * @var array The last returned news information
     */
    protected $_newsInfo = NULL;
    ...
    /**
     *@Decription : load news information by category id
     *
    ...
    /**
     *@Description : load news category information by id
     *
     *@Param int $categoryId
     *
     *@return: array
    ...
    {
        if($this->_newsInfo["news_id"] == $newsId) {
        ...
        if($row = $this->_db->fetchArray()) {
            $this->_newsInfo = $row;
            $this->rebuildNews($this->_newsInfo);
     ...
     * @param int $limitItems The limitation of news items
     *
     * @return array
     */
    ...
    /**
     * get news list by key word
     *
     *@param string $keyword The key word to search
     *@param int $categoryId The news category id
     *
     *@return: array
     */
