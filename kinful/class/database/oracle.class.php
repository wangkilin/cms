...
class oracle
{
	...
	public function oracle($dbSeq=0)
	{
		 global $MY_db_config;
		 global $MY_lang;
		 include_once(MY_ROOT_PATH."language/class/".MY_kernel::getUserLang()."/oracle.lang.php");//load class language
	...
	private function connect($connArray)
	{
		...
		if(is_resource($conn))
		{
			...
			$this->_errorStr= __CLASS__."->".__FUNCTION__."()".$MY_lang->classModule['oracle']['failConnection'];
