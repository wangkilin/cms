...
require_once(dirname(__FILE__) . '/class/module_system_front.class.php');

function system_output ($moduleInfo, $parameterExpressionString = null)
{
    global $my_client_type;

    $MyNewsModule = new My_System_Module ($moduleInfo);
