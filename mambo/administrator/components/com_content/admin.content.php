<?php
/**
* @version $Id: admin.content.php,v 1.5 2004/10/12 03:21:44 dappa Exp $
* @package Mambo_4.5.1
...
function viewContent( $sectionid, $option ) {
 ...
 $where[] = "f.content_id = c.id";
	...
	. "\n LEFT JOIN #__users AS u ON u.id = checked_out"
...
function changeContent( $cid=null, $state=0, $section, $option ) {
	...
	if ( $state == "-1" ) {
		$msg = $total ." ". $adminLanguage->A_COMP_CONTENT_ARCHIVED;
	} else if ( $state == "1" ) {
