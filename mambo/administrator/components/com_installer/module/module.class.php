<?php
/**
* @version $Id: module.class.php,v 1.12 2004/09/22 15:57:41 prazgod Exp $
* @package Mambo_4.5.1
...
class mosInstallerModule extends mosInstaller {
	...
	*/
	function uninstall( $id, $option, $client=0 ) {
		...
		if ($row->iscore) {
			HTML_installer::showInstallMessage( $row->title . 'is a core module, and can not be uninstalled.<br />You need to unpublish it if you don\'t want to use it',
				'Uninstall -  error', $this->returnTo( $option, 'module', $row->client_id ? '' : 'admin' ) );
			exit();
		}
