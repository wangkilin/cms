<?php
/**
* @version $Id: admin.massmail.html.php,v 1.1 2004/10/01 20:09:35 mibi Exp $
* @package Mambo_4.5.1
...
<table class="adminheading">
	<tr>
		<th class="massemail"><?php echo $adminLanguage->A_COMP_MASS_MAIL;?></th>
	</tr>
</table>
<table class="adminform">
	<tr>
		<td width="150"><?php echo $adminLanguage->A_COMP_MASS_GROUP;?>:</td>
		<td width="85%"><?php echo $lists['gid']; ?></td>
	</tr>
	<tr>
		<td width="150"><?php echo $adminLanguage->A_COMP_MASS_CHILD;?>:</td>
		<td width="85%"><input type="checkbox" name="mm_recurse" value="RECURSE" /></td>
	</tr>
	<tr>
		<td width="150"><?php echo $adminLanguage->A_COMP_MASS_SUB;?>:</td>
		<td width="85%"><input class="inputbox" type="text" name="mm_subject" value="" size="50"></td>
	</tr>
	<tr>
		<td width="150" valign="top"><?php echo $adminLanguage->A_COMP_MASS_MESS;?>:</td>
