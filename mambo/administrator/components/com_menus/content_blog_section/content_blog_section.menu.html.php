...
function edit( &$menu, &$lists, &$params, $option ) {
	...
	<tr>
		<th>
		<?php echo $menu->id ? $adminLanguage->A_EDIT : $adminLanguage->A_COMP_ADD;?> <?php echo $adminLanguage->A_COMP_MENUS_MENU_ITEM;?> :: <?php echo $adminLanguage->A_COMP_MENUS_BLOG;?> - <?php echo $adminLanguage->A_COMP_MENUS_CONT_SEC_MULTI;?>
		</th>
	</tr>
	</table>
