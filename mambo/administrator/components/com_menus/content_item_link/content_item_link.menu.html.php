...
function edit( &$menu, &$lists, &$params, $option, $content ) {
	...
	<tr>
		<th>
		<?php echo $menu->id ? $adminLanguage->A_EDIT : $adminLanguage->A_COMP_ADD;?> <?php echo $adminLanguage->A_COMP_MENUS_MENU_ITEM;?> :: <?php echo $adminLanguage->A_COMP_FEED_LINK;?> - <?php echo $adminLanguage->A_COMP_MENUS_CONTENT_ITEM;?>
		</th>
	</tr>
	</table>
	...
	<tr>
		...
		<?php echo $adminLanguage->A_COMP_MENUS_CONTENT_TO_LINK;?>:
		</td>
		<td width="80%">
