...
function editSection( &$menu, &$lists, &$params, $option ) {
	...
	<tr>
		<th>
		<?php echo $menu->id ? $adminLanguage->A_EDIT : $adminLanguage->A_COMP_ADD;?> <?php echo $adminLanguage->A_COMP_MENUS_MENU_ITEM;?> :: <?php echo $adminLanguage->A_COMP_MENUS_LIST;?>  - <?php echo $adminLanguage->A_COMP_MENUS_CONT_SEC;?>
		</th>
	</tr>
	</table>
	...
	<tr>
		<td align="right" valign="top"><?php echo $adminLanguage->A_COMP_SECTION;?>:</td>
		<td colspan="2">
