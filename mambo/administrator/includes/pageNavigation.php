<?php
/**
* @version $Id: pageNavigation.php,v 1.2 2004/10/11 03:36:33 dappa Exp $
* @package Mambo_4.5.1
...
*/
	function orderUpIcon( $i, $condition=true, $task='orderup' ) {
		...
		if (($i > 0 || ($i+$this->limitstart > 0)) && $condition) {
		    return '<a href="#reorder" onClick="return listItemTask(\'cb'.$i.'\',\''.$task.'\')" title="'.$adminLanguage->A_MOVE_UP.'">
				<img src="images/uparrow.png" width="12" height="12" border="0" alt="'.$adminLanguage->A_MOVE_UP.'">
			</a>';
  		} else {
  		    return '&nbsp;';
		}
...
*/
	function orderDownIcon( $i, $n, $condition=true, $task='orderdown' ) {
		...
		if (($i < $n-1 || $i+$this->limitstart < $this->total-1) && $condition) {
			return '<a href="#reorder" onClick="return listItemTask(\'cb'.$i.'\',\''.$task.'\')" title="'.$adminLanguage->A_MOVE_DOWN.'">
				<img src="images/downarrow.png" width="12" height="12" border="0" alt="'.$adminLanguage->A_MOVE_DOWN.'">
			</a>';
  		} else {
  		    return '&nbsp;';
		}
