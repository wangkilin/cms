<?php
/**
* @version $Id: index3.php,v 1.3 2004/10/11 03:36:33 dappa Exp $
* @package Mambo_4.5.1
...
<link rel="stylesheet" href="templates/<?php echo $mainframe->getTemplate().(!$adminLanguage->RTLsupport ? '/css/template_css.css' : '/css/template_css_rtl.css'); ?>"  type="text/css"> <!-- rtl change -->
