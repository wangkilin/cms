<?php
/**
* @version $Id: index.php,v 1.3 2004/09/30 22:53:14 dappa Exp $
* @package Mambo_4.5.1
...
<table width="100%" class="menuline" cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <td class="menubackgr" align="right"><a href="index2.php?option=logout" style="color: #FF9E31; font-weight: bold"><?php echo $adminLanguage->A_LOGOUT;?></a> <strong><?php echo $my->username;?></strong>&nbsp;</td>
    </tr>
</table>
