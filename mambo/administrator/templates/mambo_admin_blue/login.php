<?php
/**
* @version $Id: login.php,v 1.3 2004/10/12 03:24:35 dappa Exp $
* @package Mambo_4.5.1
...
<style type="text/css">
@import url(templates/mambo_admin_blue/css/<?php echo (!$adminLanguage->RTLsupport) ? 'admin_login.css' : 'admin_login_rtl.css'; ?>); <!-- rtl change -->
</style>
	...
	<div class="login">
		<div class="login-form">
			...
			<div class="form-block">
	        	...
	        	<div align=<?php echo ($adminLanguage->RTLsupport) ? '"right"' : '"left"'; ?>><input type="submit" name="submit" class="button" value="µÇÂ¼" /></div>
        	</div>
			</form>
    	</div>
