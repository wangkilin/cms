<?php
/**
* @version $Id: english.php,v 1.59 2004/09/22 20:47:58 stingrey Exp $
* @package Mambo_4.5.1
...
DEFINE('_CMN_NEW_ITEM_LAST','New items default to the last place');
DEFINE('_CMN_NEW_ITEM_FIRST','New items default to the first place');
...
DEFINE('_ENQUIRY_TEXT','This is an enquiry e-mail from');
DEFINE('_COPY_TEXT','This is a copy of the following message you sent to the Administrator at %s');
...
DEFINE('_REGISTER_REQUIRED','Fields mark with an asterisk (*) are required.');
...
DEFINE('_SEARCH_CATEGORY','Section/Cateogry');
...
DEFINE('_MAIL_SUB','New User Submitted');
DEFINE('_MAIL_MSG','Hello $adminName,\n\nA new user $type, $title, has been submitted by $author'
.' for the $mosConfig_live_site website.\n'
