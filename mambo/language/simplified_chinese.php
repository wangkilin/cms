...
/*
 simplified_chinese.php for Mambo4.5.1a pro
 Mambo4.5.1a pro 前台简体中文包
...
DEFINE('_MORE','更多...');
DEFINE('_ON_NEW_CONTENT', "一篇新文章由 %s 提交，名为 %s." );
...
/** contact.php */
DEFINE('_ENQUIRY','问候');
DEFINE('_ENQUIRY_TEXT','这是一封问候信，来自');
DEFINE('_COPY_TEXT','这是您发送给 %s 管理员的消息的副本');
