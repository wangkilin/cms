<?php
$smarty->assign('includePage', 'sm/bzcs.php');
function bz()
{
...
if($ra==0) {
    ...
    $rn=intval($nonglidata[$nongliyear-1921]/65536);
...
$yearlast = ($year - 1) * 5 + intval(($year - 1) / 4) - intval(($year - 1) / 100) + intval(($year - 1) / 400);
...
if ($sex==1) {
    $sexok = 1;
    echo("乾造：" . $a[20 + $yg] .  $a[30 + $yz] .  $a[20 + $mg] .  $a[30 + $mz] .  $a[20 + $dg] .  $a[30 + $dz] 
        . $a[20 + $tg] .  $a[30 + $tz] . $qyjs . "岁运");
}
else {
    $sexok = 0;
    echo("坤造：" . $a[20 + $yg] .  $a[30 + $yz] .  $a[20 + $mg] .  $a[30 + $mz] .  $a[20 + $dg] .  $a[30 + $dz] 
        . $a[20 + $tg] .  $a[30 + $tz] . $qyjs . "岁运");
}
...
switch($tgs) {
case 1:
echo("<br>" . "在事业方面，可以受到兄弟的帮助。" );
break;
case 2:
echo("<br>" . "在事业方面，可以受到姊妹的帮助" );
break;
case 3:
case 4:
echo("<br>" . "在事业方面，可以从事思考方面的职业" );
break;
case 5:
echo("<br>" . "在事业方面，可以受到父亲的帮助。" );
break;
case 6:
echo("<br>" . "在事业方面，可以受到配偶或与配偶同辈的帮助。" );
break;
case 7:
case 8:
echo("<br>" . "在事业方面，可以受到师长、上司的帮助" );
break;
case 9:
echo("<br>" . "在事业方面，可以受到母亲辈的帮助。" );
break;
case 0:
echo("<br>" . "在事业方面，可以受到长辈贵人的帮助。" );
break;
}
...
break;
case 3:
echo("<br>" . "妻贤慧能持家，得衣食财帛，妻肥胖。");
break;
case 4:
echo("<br>" . "妻子美貌，但志高无才能。");
break;
case 5:
echo("<br>" . "妾夺妻权，但有善待丈夫。不爱妻反爱妾。");
break;
case 6:
echo("<br>" . "得妻扶助成功，白手成家自然富贵。");
break;
case 7:
...
break;
case 8:
echo("<br>" . "独立持家，地位安定，又得妻力，或与名门之女结婚");
echo("<br>" . "妻妾相貌敦厚，贤淑温顺。");
break;
case 9:
echo("<br>" . "妻做事敏捷迅速.");
...
echo($west[$day] . "<br>" . $west[100 * $month + $day] . "<br>");
}

$smarty->register_function('outputBz', 'bz');
?>
