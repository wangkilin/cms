<?include file="common/astroCommon.php"?>
  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
    <tbody>
      <tr>
        <td width="100%" colspan="6" class="ttop"><?$_thisYear?>年12生肖运势抢先播报</td>
      </tr>
      <tr>
        <td colspan="6" class="new2"><span class="red">·你知道十二生肖<?$_thisYear?>年会走什么好运吗？发财？升迁？还是遇桃花？快来点击查看属于你的<?$_thisYear?>生肖运程吧！</span></td>
      </tr>
      <tr>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=鼠" target="_blank"><img src="<? $siteTheme ?>/images/sx1.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=牛" target="_blank"><img src="<? $siteTheme ?>/images/sx2.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=虎" target="_blank"><img src="<? $siteTheme ?>/images/sx3.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=兔" target="_blank"><img src="<? $siteTheme ?>/images/sx4.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=龙" target="_blank"><img src="<? $siteTheme ?>/images/sx5.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=蛇" target="_blank"><img src="<? $siteTheme ?>/images/sx6.gif" width="90" height="80" border="0"></a></td>
      </tr>
      <tr>
        <td class="new"><DIV align="center"><STRONG>生肖鼠<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖牛<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖虎<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖兔<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖龙<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖蛇<?$_thisYear?>运势</STRONG></DIV></td>
      </tr>
      <tr>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=马" target="_blank"><img src="<? $siteTheme ?>/images/sx7.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=羊" target="_blank"><img src="<? $siteTheme ?>/images/sx8.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=猴" target="_blank"><img src="<? $siteTheme ?>/images/sx9.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=鸡" target="_blank"><img src="<? $siteTheme ?>/images/sx10.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=狗" target="_blank"><img src="<? $siteTheme ?>/images/sx11.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=猪" target="_blank"><img src="<? $siteTheme ?>/images/sx12.gif" width="90" height="80" border="0"></a></td>
      </tr>
      <tr>
        <td class="new"><DIV align="center"><STRONG>生肖马<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖羊<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖猴<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖鸡<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖狗<?$_thisYear?>运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖猪<?$_thisYear?>运势</STRONG></DIV></td>
      </tr>
    </tbody>
  </table>
  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
...
<option value="O">O型</option><option value="A">A型</option><option value="B">B型</option><option value="AB">AB型</option>
	...
	<select name="d" class="sele02" id="d">
	  ...
	  <?selectStepOptions start=1 end=31?>
	</select>
