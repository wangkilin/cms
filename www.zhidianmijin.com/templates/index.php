<?if ($xing<>'')?>
  <?include file="common/crackBorder.php" includePage='common/displayUserInfo.php' ?>
<?else?>
  <?include file="common/crackBorder.php" includePage='common/enterAllInfoForm.php' ?>
<?/if?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
  <TBODY>   <tr>
      <TD class=ttop style="PADDING-BOTTOM: 1px" vAlign=top>今日黄历 &nbsp; <a href="?m=6&sm=6&yy=<? $_thisYear ?>&mm=<? $_thisMonth ?>&dd=<? $_thisDay ?>&act=crz">详细内容</a></TD>
    </tr> 
    <tr>
      <TD vAlign=top class=new style="PADDING-BOTTOM: 8px"><font color=red><?$_nowDate?></font> <?$nn?>  <? $weeklyInfo[$rs.xq] ?> <?$suici?> <font color=red><?$cong?></font></TD>
    </tr>
    <tr>
      <TD vAlign=top class=new style="PADDING-BOTTOM: 8px"><strong>宜</strong> <font color=red> <?$yi?></font></TD>
    </tr>
    <tr>
      <TD vAlign=top class=new style="PADDING-BOTTOM: 8px"><strong>忌</strong> <font color=blue> <?$ji?> </font></TD>
    </tr>
  </TBODY>
</TABLE>
