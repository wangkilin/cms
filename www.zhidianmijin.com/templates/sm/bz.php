...
<td  width="12%" rowspan="2" bgcolor="#FFFFFF" class="new">出生时间：</td>
  ...
  <td width="30%"  rowspan="6" bgcolor="#FFFFFF" class="new" style="padding-left:4px;padding-right:4px;">本命属<?$sx?>，<?$ygz|layin?>命。五行<?$mainw?><?$mainq?>；日主天干为<b><?$dg1|tgdzwh?></b>，生于<?$yue1|siji?>季。<br />
    （同类<?$tnwh?>；异类<?$ynwh?>。）<br /><hr size="1"><font color="#aaaaaa" style="font-size:12px"><img src="images/icon.gif" width="9" height="9" border="0"> 重要说明：本结果为系统自动分析，仅供参考，八字缺什么与补什么无关，具体应由专业老师分析！</font>　</td>
 </tr>
 <tr>
  ...
  <td bgcolor="#FFFFFF" class="new" ><?$hh2|DiZhi?>时</td>
 </tr>
 ...
 <tr>
  ...
  <td bgcolor="#FFFFFF" class="new" ><?$yg1|tgdzwh?><?$yz1|tgdzwh?></td>
  <td bgcolor="#FFFFFF" class="new" ><?$mg1|tgdzwh?><?$mz1|tgdzwh?></td>
  <td bgcolor="#FFFFFF" class="new" ><?$dg1|tgdzwh?><?$dz1|tgdzwh?></td>
  <td bgcolor="#FFFFFF" class="new" ><?$tg1|tgdzwh?><?$tz1|tgdzwh?></td>
 </tr>
 <tr>
  <td  colspan="2" bgcolor="#FFFFFF" class="new">纳音：</td>
  <td bgcolor="#FFFFFF" class="new" ><?$ygz|layin?></td>
  <td bgcolor="#FFFFFF" class="new" ><?$mgz|layin?></td>
  <td bgcolor="#FFFFFF" class="new" ><?$dgz|layin?></td>
  <td bgcolor="#FFFFFF" class="new" ><?$tgz|layin?></td>
 </tr>
</tbody>
...
<tr>
  <td class=new>八字五行个数 : <?$wnum1?>个金，<?$wnum2?>个木，<?$wnum3?>个水，<?$wnum4?>个火，<?$wnum5?>个土
    ...
    <TBODY>
<tr>
  <td class=new>四季用神参考 : 日主天干<?$dg1|tgdzwh?>生于<?$yue1|siji?>季,<?$sjrs?>。
</td>
</tr><tr>
  <td class=new>穷通宝鉴调候用神参考 : <?$dg1?><?$dg1|tgdzwh?>生于<?$mz1?>月，<?$qtbj?>
</td>
</tr>
    </TBODY>
</TABLE>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"   style="MARGIN-BOTTOM: 10px; table-layout:fixed;word-wrap:break-word;">
  <tbody>
    ...
    <tr>
      <td  bgcolor="#FFFFFF" class="new"><?$hh2|DiZhi?>时时生</td>
