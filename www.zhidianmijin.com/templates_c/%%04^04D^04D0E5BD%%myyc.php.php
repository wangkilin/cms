<?php /* Smarty version 2.6.6, created on 2009-06-28 14:12:50
         compiled from yuce/myyc.php */ ?>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
<tbody><tr>
  <td width="79%" class="ttd"><span class="red">面热预测:</span>
    <br>
脸如火在烧？热的不得了？不是感冒，又没发烧，为何脸会红？不能不知道！面热预测，告诉你面热征兆、面热吉凶、面热的原因，快来算哦~ 。</td>
    <td width="21%" class="ttd"><img src="diary_book/images/myyc.gif" width="128" height="122"></td>
</tr>
<form name="form1" onSubmit="return submitchecken()" method="post" action="">
<input type="hidden" name="act" value="ok" />
  <tr>
    <td colspan="2" class="new">&nbsp;面热时间：<select id="stime" style="WIDTH: 100px" name="stime" size="1">
