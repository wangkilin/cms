<?php /* Smarty version 2.6.6, created on 2009-08-05 23:26:49
         compiled from astro/index.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'selectStepOptions', 'astro/index.php', 105, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "common/astroCommon.php", 'smarty_include_vars' => array()));
...
unset($_smarty_tpl_vars);
 ?>
  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
    <tbody>
      <tr>
        <td width="100%" colspan="6" class="ttop"><?php echo $this->_tpl_vars['_thisYear']; ?>
年12生肖运势抢先播报</td>
      </tr>
      <tr>
        <td colspan="6" class="new2"><span class="red">·你知道十二生肖<?php echo $this->_tpl_vars['_thisYear']; ?>
年会走什么好运吗？发财？升迁？还是遇桃花？快来点击查看属于你的<?php echo $this->_tpl_vars['_thisYear']; ?>
生肖运程吧！</span></td>
      </tr>
      <tr>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=鼠" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx1.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=牛" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx2.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=虎" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx3.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=兔" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx4.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=龙" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx5.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=蛇" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx6.gif" width="90" height="80" border="0"></a></td>
      </tr>
      <tr>
        <td class="new"><DIV align="center"><STRONG>生肖鼠<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖牛<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖虎<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖兔<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖龙<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖蛇<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
      </tr>
      <tr>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=马" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx7.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=羊" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx8.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=猴" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx9.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=鸡" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx10.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=狗" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx11.gif" width="90" height="80" border="0"></a></td>
        <td class="new"><a href="?m=2&sm=1&flag=12&sx=猪" target="_blank"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/sx12.gif" width="90" height="80" border="0"></a></td>
      </tr>
      <tr>
        <td class="new"><DIV align="center"><STRONG>生肖马<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖羊<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖猴<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖鸡<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖狗<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
        <td class="new"><DIV align="center"><STRONG>生肖猪<?php echo $this->_tpl_vars['_thisYear']; ?>
运势</STRONG></DIV></td>
      </tr>
    </tbody>
  </table>
  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
    <tbody>
      ...
      <tr>
        <td colspan="2" class="new"><a href="?m=2&sm=9&type=today">今日运程</a>
      ...
      <tr>
        <td width="49%" class="new">	<form action=?m=2&sm=1& method=post target=_blank>
 <input type=hidden name=flag value=4><select name=astro >
  ...
  <option value="双鱼座">双鱼座 2月20-3月20</option>
	...
	<input name="" type="submit" value="星座详解" ></p>
        ...
        <td width="51%" class="new"><form action=?m=2&sm=1& method=post target=_blank>
...
<option value="O">O型</option><option value="A">A型</option><option value="B">B型</option><option value="AB">AB型</option>
	...
	<input name="" type="submit" value="星座+血型"></p>
      ...
      <tr>
        <td class="new"><form action=?m=2&sm=1& method=post target=_blank>
	...
	<select name="d" class="sele02" id="d">
	  ...
	  <?php echo selectStepOptions(array('start' => 1,'end' => 31), $this);?>
