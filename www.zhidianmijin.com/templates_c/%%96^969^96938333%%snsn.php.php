...
恭喜您，根据推算，你很可能会有一个&nbsp;<font color="#FF0000"><?php echo $this->_tpl_vars['baby']; ?>
</font>
<?php else: ?>
您如果想生个<font color="#FF0000"><?php echo $this->_tpl_vars['baby']; ?>
</font>，那么建议您在农历 <font color="#0000FF">今年 ：<?php echo $this->_tpl_vars['yuef']; ?>
&nbsp;&nbsp;明年：<?php echo $this->_tpl_vars['nyuef']; ?>
</font> 怀孕的话机会比较大！<?php endif; ?><br><br>
