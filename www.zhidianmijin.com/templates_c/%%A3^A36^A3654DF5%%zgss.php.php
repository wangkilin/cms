...
<?php if (( $this->_tpl_vars['str1'] <> "" && $this->_tpl_vars['str2'] <> "" && $this->_tpl_vars['str3'] <> "" )): ?>
        <tr bgcolor="#EFF8FE">
            <td class="new" colspan="2" valign="middle">
                <br>您输入的三个汉字为：<font color=blue><?php echo $this->_tpl_vars['str1']; ?>
&nbsp;<?php echo $this->_tpl_vars['str2']; ?>
&nbsp;<?php echo $this->_tpl_vars['str3']; ?>
</font><br><br>
                <font color=cc6600>〖诗曰〗：</font><?php echo $this->_tpl_vars['zhugetitle']; ?>
<br><br>
                <font color=cc6600>〖签释〗：</font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['zhugecontent']; ?>
<br><br>
            </td>
        </tr>
<?php endif; ?>
